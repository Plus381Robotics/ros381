    ...
    match tactic_state:
        ...
        case 15:
            if snapshot_fsm(1, 10) < 0:
                ...
                tactic_state = 20
        case 20:
            move_on_angle(dist=0.19, dir=1, phi=-math.pi * 0.5)
            tactic_state = 30
        case 30:
            if move_success():
                tactic_state = 40
        ...
        case 79:
            if lift_carry(-1) < 0:
                tactic_state = 80
        case 80:
            move_on_angle(dist=0.16, dir=-1, phi=math.pi * 0.5, v_max=0.25)
            tactic_state = 85
        case 85:
            if move_stacked():
        ...
        case 124:
            ...
            if get_side() == 1:
                ...
                direction = 1
            move_to_xy(x=-0.2, y=-0.78, dir=direction)
            tactic_state = 125
        case 125:
            if move_success():
                tactic_state = 130
        ...
        case 230:
            if snapshot_fsm(1, 10) < 0:
                ...
                tactic_state = 240
        case 240:
            move_on_angle(dist=0.1675, dir=1, phi=math.pi)
            tactic_state = 241
        case 241:
            if move_success() or move_stacked():
                tactic_state = 242
